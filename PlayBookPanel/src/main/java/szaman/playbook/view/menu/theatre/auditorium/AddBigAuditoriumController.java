 ...
 *
 * Klasa kontrolerska tworzenia nowej duzej sali - AddBigAuditoriumController.java.
 * 
 */
...
public class AddBigAuditoriumController 
{
...
/*************************************************************************************************************************************/
    ...
    private void handleOk(ActionEvent event) throws SQLException, ClassNotFoundException, PropertyVetoException 
    {
        ...
        if (result.get() == okButton)
        {
            ...
            connector.addAuditorium(chosenTheatre.getTheatreId(), auditoriumNumber, (100 - missingSlotList.size()), missingSlots, "Big");
        ...
        {
            System.out.println("AddBigAuditoriumCancel detected!"); //kontrola, czy dziala interakcja.
            alert.close();
        }
    ...
    {
        System.out.println("AddBigAuditoriumBack detected!"); //kontrola, czy dziala interakcja.
        mainApp.showAuditoriumDatabase(email, userName, chosenTheatre);
    }
}
