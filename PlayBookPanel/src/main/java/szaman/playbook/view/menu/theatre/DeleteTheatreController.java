 ...
 *
 * Klasa kontrolerska usuwania teatru - DeleteTheatreController.java.
 * 
 */
...
public class DeleteTheatreController
{
    ...
    public void setDialogStage(Stage dialogStage, int theatreID, String adminEmail) throws SQLException, ClassNotFoundException 
    {
    ...
    //Gdy liczba bledow jest rowna zero:
        if (errorMessage.length() == 0) 
        {
            ...
            connector.deleteTheatre(theatreID);
            alert.setContentText("Teatr został usunięty!");
            alert.showAndWait();
            return true;
        } 
