 ...
 *
 * Klasa kontrolerska wyswietlania sredniej archiwalnej sali - ShowMediumArchiveAuditoriumController.java.
 * 
 */
...
public class ShowMediumArchiveAuditoriumController 
{
    ...
    public void setMainApp(Core mainApp, String email, String userName, String missingSlots, String auditoriumInfo) throws SQLException, ClassNotFoundException, PropertyVetoException 
    {
        ...
        auditoriumInfoLabel.setText("Wizualizacja sali " + auditoriumInfo + " (Typ Medium)");
...
/*************************************************************************************************************************************/
    ...
    {
        System.out.println("ShowMediumArchiveAuditoriumBack detected!"); //kontrola, czy dziala interakcja.
