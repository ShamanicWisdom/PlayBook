 ...
 *
 * Klasa kontrolerska usuwania konta administratora - AdminSelfDeleteAccountController.fxml.java.
 * 
 */
...
public class AdminSelfDeleteAccountController
{
    @FXML
    ...
    public void setDialogStage(Stage dialogStage, String adminEmail) throws SQLException, ClassNotFoundException 
    {
    ...
    @FXML
    private void handleOk(ActionEvent event) throws SQLException, ClassNotFoundException, NoSuchAlgorithmException, PropertyVetoException 
    {
        System.out.println("Admin SelfDeleteOK detected!"); //kontrola, czy dziala interakcja.
        if (validator()) 
        {
            okClicked = true;
            dialogStage.close();
    ...
    //Walidator danych.
    private boolean validator() throws SQLException, ClassNotFoundException, NoSuchAlgorithmException, PropertyVetoException 
    {
    ...
    //Gdy liczba bledow jest rowna zero:
        if (errorMessage.length() == 0) 
        {
            ...
            connector.deleteAccount(adminEmail);
            alert.setContentText("Konto zostało usunięte!");
            alert.showAndWait();
            return true;
        } 
    ...
    {
        System.out.println("Admin Self Delete Account detected!"); //kontrola, czy dziala interakcja.
        dialogStage.close();
    }
}