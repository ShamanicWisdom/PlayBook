 ...
 *
 * Klasa kontrolerska usuwania seansu - DeleteShowController.java.
 * 
 */
...
public class DeleteShowController
{
    ...
    public void setDialogStage(Stage dialogStage, String adminEmail, int showID) throws SQLException, ClassNotFoundException 
    {
    ...
    //Gdy liczba bledow jest rowna zero:
        if (errorMessage.length() == 0) 
        {
            ...
            connector.deleteShow(showID);
            alert.setContentText("Seans został usunięte!");
            alert.showAndWait();
            return true;
        } 
