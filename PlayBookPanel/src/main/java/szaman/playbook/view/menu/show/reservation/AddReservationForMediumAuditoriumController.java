 ...
 *
 * Klasa kontrolerska rezerwacji miejsc w sredniej sali - AddReservationForMediumAuditoriumController.java.
 * 
 */
...
public class AddReservationForMediumAuditoriumController 
{
...
/*************************************************************************************************************************************/
    ...
    {
        System.out.println("AddReservationForMediumAuditoriumBack detected!"); //kontrola, czy dziala interakcja.
        mainApp.showReservationDatabase(email, userName, chosenShow);
    }
}
