 ...
 *
 * Klasa kontrolerska edycji sredniej sali - EditMediumAuditoriumController.java.
 * 
 */
...
public class EditMediumAuditoriumController 
{
...
/*************************************************************************************************************************************/
    ...
    private void handleOk(ActionEvent event) throws SQLException, ClassNotFoundException, PropertyVetoException 
    {
        ...
        if (result.get() == okButton)
        {
            ...
            alert.close();
            connector.editAuditorium(chosenTheatre.getTheatreId(), auditoriumNumber, (80 - missingSlotList.size()), missingSlots);
        ...
        {
            System.out.println("EditMediumAuditoriumCancel detected!"); //kontrola, czy dziala interakcja.
            alert.close();
        }
    ...
    {
        System.out.println("EditMediumAuditoriumBack detected!"); //kontrola, czy dziala interakcja.
        mainApp.showAuditoriumDatabase(email, userName, chosenTheatre);
    }
}
