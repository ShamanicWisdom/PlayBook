 ...
 *
 * Klasa kontrolerska edycji rezerwacji miejsc w malej sali - EditReservationForSmallAuditoriumController.java.
 * 
 */
...
public class EditReservationForSmallAuditoriumController 
{
...
/*************************************************************************************************************************************/
    ...
    {
        System.out.println("EditReservationForSmallAuditoriumBack detected!"); //kontrola, czy dziala interakcja.
        mainApp.showReservationDatabase(email, userName, chosenShow);
    }
}
