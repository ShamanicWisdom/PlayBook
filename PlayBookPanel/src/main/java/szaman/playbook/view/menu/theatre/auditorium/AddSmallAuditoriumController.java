 ...
 *
 * Klasa kontrolerska tworzenia nowej malej sali - AddSmallAuditoriumController.java.
 * 
 */
...
public class AddSmallAuditoriumController 
{
...
/*************************************************************************************************************************************/
    ...
    private void handleOk(ActionEvent event) throws SQLException, ClassNotFoundException, PropertyVetoException 
    {
        ...
        if (result.get() == okButton)
        {
            ...
            connector.addAuditorium(chosenTheatre.getTheatreId(), auditoriumNumber, (50 - missingSlotList.size()), missingSlots, "Small");
        ...
        {
            System.out.println("AddSmallAuditoriumCancel detected!"); //kontrola, czy dziala interakcja.
            alert.close();
        }
    ...
    {
        System.out.println("AddSmallAuditoriumBack detected!"); //kontrola, czy dziala interakcja.
        mainApp.showAuditoriumDatabase(email, userName, chosenTheatre);
    }
}
