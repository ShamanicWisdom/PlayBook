 ...
 *
 * Klasa kontrolerska usuwania sali - DeleteAuditoriumController.java.
 * 
 */
...
public class DeleteAuditoriumController
{
    @FXML
    ...
    public void setDialogStage(Stage dialogStage, int auditoriumID, String adminEmail) throws SQLException, ClassNotFoundException 
    {
    ...
    //Gdy liczba bledow jest rowna zero:
        if (errorMessage.length() == 0) 
        {
            ...
            connector.deleteAuditorium(auditoriumID);
            alert.setContentText("Sala została usunięta!");
            alert.showAndWait();
            return true;
        } 
