 ...
 *
 * Klasa kontrolerska usuwania konta uzytkownika - DeleteAccountController.java.
 * 
 */
...
public class DeleteAccountController
{
    ...
    //Gdy liczba bledow jest rowna zero:
        if (errorMessage.length() == 0) 
        {
            ...
            connector.deleteAccount(userEmail);
    ...
    {
        System.out.println("AccountDeleteCancel detected!"); //kontrola, czy dziala interakcja.
        dialogStage.close();
    }
}