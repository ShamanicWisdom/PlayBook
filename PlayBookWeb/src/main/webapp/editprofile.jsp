...
<!--JSP edycji profilu uzytkownika-->
...
<html>
    ...
    <body>
        ...
        <br /><br /><br /><br /><br />
        <p><h1>Edytuj swój profil</h1></p><br /><br />
    
        <form method="post" action="ChangePassword">    
            <table align="center" class="form-table">
                <td>Imię:</td>
                <td><input type="text" name="name" value="${dataUserName}"/></td>
                <td>Nazwisko:</td>
                <td><input type="text" name="surname" value="${dataUserSurname}"/></td>
                <td>Email:</td>
                <td><input type="text" name="email" value="${dataUserEmail}"/></td>
                <td>Numer Telefonu:</td>
                <td><input type="text" name="phoneNumber" value="${dataUserPhoneNumber}"/></td>
